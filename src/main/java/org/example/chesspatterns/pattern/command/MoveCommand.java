...
//
//            if (isSimulation)
//                selectedType = PieceType.QUEEN; // Bei Simulationen automatisch zur Dame befördern, um die KI zu stärken
//
//            else {
//                selectedType = GameManager.getInstance().askPromotionChoice(piece.isWhite);
//            }
//
...
public class MoveCommand implements Command {
    ...
    public void execute() {
        ...
        // 2. Figur auf dem Board verschieben
    ...
    @Override
    public void undo() {
        // 1. Bewegte Figur zurück aufs Startfeld
        board.setPiece(startRow, startCol, movedPiece);

        // 2. Geschlagene Figur (falls vorhanden) zurück aufs Zielfeld
